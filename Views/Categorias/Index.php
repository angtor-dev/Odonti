    ...
    <div class="page-inner py-5">
        <div class="d-flex align-items-center justify-content-between flex-column flex-md-row">
            <div class="text-white">
                <h3 class="pb-2">Categorias</h3>
                <span class="opacity-75 mb-2">Gestiona las categorias para los insumos</span>
            </div>
            <?php if (tienePermiso('categorias', Permiso::REGISTRAR)): ?>
                <div>
    ...
    <div class="card border-0 box-shadow-alt">
        <div class="card-body p-4">
            <div class="table-responsive table-odonti">
                <table class="datatable table table-striped table-hover" id="tabla-categoria">
                    <thead>
                        <tr>
                            <th>#</th>
                            <th>Nombre</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex justify-content-evenly w-100 gap-3">
                                        <?php if (tienePermiso('categorias', Permiso::ACTUALIZAR)): ?>
                                        ...
                                        <?php endif ?>
                                        <?php if (tienePermiso('categorias', Permiso::ELIMINAR)): ?>
...
<script>
    document.addEventListener('DOMContentLoaded', e => {
        tablaCategorias = new DataTable('#tabla-categoria', {
