    ...
    <div class="card" style="max-width: 650px;">
            ...
            <form method="post" id="form-insumo">
                ...
                <div class="row gy-3">
                    <div class="col-md-12">
                        ...
                        <textarea class="form-control" id="descripcion" name="descripcion" maxlength="150" required><?= $insumo->getDescripcion() ?></textarea>
                    ...
                    <div class="col-md-12">
                        ...
                        <input class="form-control" type="text" id="codigo" name="codigo" maxlength="20" value="<?= $insumo->getCodigo() ?>">
                        ...
                        <div class="input-group">
                            ...
                            <select class="form-select" name="idCategoria" id="idCategoria">
                                ...
                                <?php foreach ($categorias as $categoria): ?>
                                    <option value="<?= $categoria->id ?>" <?= $categoria->id == $insumo->getIdCategoria() ? "selected" : "" ?>>
                                        <?= $categoria->getNombre() ?>
                                    </option>
                                <?php endforeach ?>
                            </select>
        ...
        <div class="card-footer">
            <div class="d-flex justify-content-between gap-3">
                ...
                <button type="submit" form="form-insumo" class="btn btn-primary">Guardar</button>
            </div>
        </div>
    </div>
</div>
